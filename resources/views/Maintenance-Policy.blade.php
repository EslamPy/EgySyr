        ...
        <section class="all">
            ...
            <section class="message" data-aos="zoom-in-up">
                <div class="Choose_box_h">
                    <h1>EgySyr Maintenance Policy</h1>
                </div>
                <div class="services-box" >
                    
                    <ol>
                      <li><strong>( Maintenance Planning )</strong>
                        We are committed to implementing regular and effective maintenance plans to ensure the continuous and sustainable performance of all equipment and systems
                      </li>
                      <li><strong>( Prevention and Regular Maintenance )</strong>
                        We adopt preventive and routine maintenance strategies to detect and resolve potential issues before they affect performance.
                      </li>
                      <li><strong>( Safety and Occupational Health )</strong>
                        We ensure a safe and healthy work environment by adhering to local and international safety and occupational health standards.
                      </li>
                      <li><strong>( Training and Skill Development )</strong>
                        We invest in ongoing training programs to keep our maintenance team updated on the latest technologies and best practices.
                      </li>
                      <li><strong>( Prompt Response to Failures )</strong>
                        We implement efficient response mechanisms to address technical failures promptly, ensuring business continuity.
                      </li>
                      <li><strong>( Replacement and Upgrades )</strong>
                        We regularly assess and upgrade equipment, replacing outdated systems with modern solutions for optimal efficiency.
                      </li>
                      <li><strong>( Maintenance Documentation )</strong>
                        We ensure accurate documentation of maintenance activities, including reports and verification of completed repairs.
                      </li>
                      <li><strong>( Cost and Efficiency )</strong>
                        We adopt continuous improvement strategies to enhance equipment and system performance over time.
                      </li>
                      <li><strong>( Continuous Improvement )</strong>
                        We adopt continuous improvement cycles for maintenance operations to ensure the ongoing enhancement of equipment and system performance.
                      </li>
                      <li><strong>( Customer Interaction )</strong>
                        We actively listen to customer feedback to improve our maintenance services and ensure client satisfaction.
                      </li>
                    </ol>
                  </div>
